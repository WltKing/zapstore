...
export default async function FiscalPage() {
  ...
  const data: FiscalConfigData | null = cfg
    ? {
        ...
        serieNfeHomolog: cfg.serieNfeHomolog,
        proxNumNfeHomolog: cfg.proxNumNfeHomolog,
        serieNfeProd: cfg.serieNfeProd,
        proxNumNfeProd: cfg.proxNumNfeProd,
        serieNfceHomolog: cfg.serieNfceHomolog,
        proxNumNfceHomolog: cfg.proxNumNfceHomolog,
        serieNfceProd: cfg.serieNfceProd,
        proxNumNfceProd: cfg.proxNumNfceProd,
