...
export function MonthSelect({ current }: { current: string }) {
  ...
  return (
    <select
      ...
      className="rounded-lg border border-neutral-300 px-3 py-2 text-sm font-medium capitalize shadow-sm focus:border-neutral-900 focus:outline-none focus:ring-1 focus:ring-neutral-900"
    >
      {options.map((m) => (
